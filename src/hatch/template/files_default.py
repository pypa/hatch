    ...
    def __init__(
        ...
        super().__init__(
            ...
            self.TEMPLATE.format(
                extra_badges=extra_badges, extra_toc=extra_toc, license_info=license_info, **dict(template_config)
            ),
        )
...
"""
    ...
    def __init__(self, template_config: TemplateConfig, plugin_config: dict):
        ...
        if project_urls:
            for label, url in project_urls.items():
                ...
                project_url_data += f'\n{normalized_label} = "{url.format(**dict(template_config))}"'

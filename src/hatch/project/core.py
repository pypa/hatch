...
class Project:
    def __init__(self, path: Path, *, name: str | None = None, config: dict | None = None) -> None:
        self._path = path
        ...
        self._root_searched: bool = False
    ...
    @staticmethod
    def initialize(project_file_path: Path, template_config: Mapping) -> None:
        import tomlkit

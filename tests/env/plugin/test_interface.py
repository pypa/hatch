...
"""
    ...
    """)
        ...
        assert "dependencies_complex" in environment.__dict__
        assert "all_dependencies_complex" in environment.__dict__

        environment.add_additional_dependencies([Dependency("extra-dep")])

        assert "dependencies_complex" not in environment.__dict__
        assert "all_dependencies_complex" not in environment.__dict__

...
def test_specific(isolation):
    ...
    assert scheme.update('9000.0.0-rc.1', '1.0', {}) == '9000rc1'


def test_major(isolation):
    scheme = StandardScheme(isolation, {})

    assert scheme.update('major', '9000.0.0-rc.1', {}) == '9001'


def test_minor(isolation):
    scheme = StandardScheme(isolation, {})

    assert scheme.update('minor', '9000.0.0-rc.1', {}) == '9000.1'
...
class TestPre:
    ...
    def test_begin(self, isolation, phase):
        ...
        assert scheme.update(phase, '9000.0.0.post7.dev5', {}) == f'9000{normalized_phase}0'
    ...
    def test_continue(self, isolation, phase):
        ...
        normalized_phase, _ = _parse_letter_version(phase, 0)
        assert scheme.update(phase, f'9000.0.0{phase}0.post7.dev5', {}) == f'9000{normalized_phase}1'
    ...
    def test_restart(self, isolation, phase):
        ...
        assert scheme.update(phase, f'9000.0.0-{other_phase}5.post7.dev5', {}) == f'9000{normalized_phase}0'
...
class TestPost:
    ...
    def test_begin(self, isolation, key):
        ...
        assert scheme.update(key, '9000.0.0-rc.3.dev5', {}) == '9000rc3.post0'

    @pytest.mark.parametrize('key', ['post', 'rev', 'r'])
    def test_continue(self, isolation, key):
        scheme = StandardScheme(isolation, {})

        assert scheme.update(key, f'9000.0.0-rc.3-{key}7.dev5', {}) == '9000rc3.post8'
...
class TestDev:
    def test_begin(self, isolation):
        ...
        assert scheme.update('dev', '9000.0.0-rc.3-7', {}) == '9000rc3.post7.dev0'

    def test_continue(self, isolation):
        scheme = StandardScheme(isolation, {})

        assert scheme.update('dev', '9000.0.0-rc.3-7.dev5', {}) == '9000rc3.post7.dev6'

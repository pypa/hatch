...
Hatch uses a 10 second timeout for network requests by default. This can be overridden by setting the
`HATCH_NETWORK_TIMEOUT` environment variable to the desired number of seconds.
